      ...
      <form className="form-uploadsong" onSubmit={handleSubmit}>
        ...
        <div className="body-div">
          <div className="left-div">
            ...
            {formSubmitted && error.previewImg && <h5>{error.previewImg}</h5>}
          </div>
