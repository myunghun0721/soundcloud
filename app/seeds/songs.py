...
def seed_songs():
    songs = [
        ...
        Song(song_url="https://soundcloud-aws.s3.amazonaws.com/demosong.mp3", title="Roll The Old Chariot", artist="Nathan Evans", album="Wellerman - The Album", release_date=datetime(2022, 11,4), genre="Pop, Folk, World, & Country", user_id=2, preview_img="https://res.cloudinary.com/dsnllj445/image/upload/v1713526756/Songs/song_previews/thiago-borrere-alvim-bf8APnBxoCk-unsplash_jzfk1c.jpg"),
